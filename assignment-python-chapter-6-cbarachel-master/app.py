...
# Chapter 6.1 Exceptions
# nothing to code. Watch the chapter's video.


# Chapter 6.2 Handling Exceptions
print("\nChapter 6.2 Handling Exceptions")
print("\nTo test the error, enter correct and bad values for age('z'), -1, etc.)")
# Run "python app.py" in the terminal to allow for user input
# start coding here...
...
print("\nChapter 6.3 Handling Different Exceptions")
# multiple except clauses to handle multiple error
...
except (ValueError, ZeroDivisinError):
    print("You didn't enter a valid age.")
else:
    print("No exceptions were thrown.")
finally:
...
# Chpter 6.7 Cost of Raising Exceptions
print("\nChapter 6.7 Cost of raising Eceptions")
